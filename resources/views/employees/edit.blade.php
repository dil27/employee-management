...
@section('content')
            ...
            @if ($employee->photo)
                <style>
                    .file-drop-zone-title {
                        background: url({{ asset($employee->photo) }}) center no-repeat;
            ...
            <div class="employee-card">
                <div class="card-col left">
                    <div class="form-group">
                        ...
                        <input type="file" name="photo" class="file-loading form-control">
                    </div>
                </div>
                ...
                <div class="card-col right">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="join_date" class="form-control date-input" id="join_date" value="{{ \Carbon\Carbon::parse($employee->join_date)->format('d/m/Y') }}" required>
                    </div>
                    <div class="form-group">
    ...
    <script>
        $('#position option').each((a, b) => {
            if ($(b).val() == '{{ $employee->position }}') {
                $(b).attr('selected', 'selected')
            }
        })
        $('#department option').each((a, b) => {
            if ($(b).val() == '{{ $employee->department }}') {
                $(b).attr('selected', 'selected')
            }
        })
